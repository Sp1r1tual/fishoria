...
export async function seedQuests(prisma: PrismaClient) {
  const quests = [
    ...
    {
      title: { uk: 'Майстер Міського озера', en: 'Master of City Lake' },
      description: {
        uk: 'Виловити по 1 екземпляру кожного виду риб та інших мешканців, що живуть у Міському озері',
        en: 'Catch at least one specimen of every fish species and inhabitant in the City Lake',
      },
      conditions: [
        {
          id: 'city_perch',
        ...
        },
        {
          ...
          value: 'rotan',
          target: 1,
          label: { uk: 'Зловити ротана', en: 'Catch a Rotan' },
        },
        {
          id: 'city_chub',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          value: 'chub',
          target: 1,
          label: { uk: 'Зловити головня', en: 'Catch a Chub' },
        },
        {
          id: 'city_pond_turtle',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          value: 'pond_turtle',
          target: 1,
          label: { uk: 'Зловити болотяну черепаху', en: 'Catch a Pond Turtle' },
        },
      ],
      xpReward: 200,
      moneyReward: 600,
      order: 8,
      imageUrl:
        'https://ysmdydtvfgtffymgillf.supabase.co/storage/v1/object/public/Game/quests_icons/quest_7_master_of_city_lake.webp',
    },
    {
      title: { uk: 'Майстер Гірської річки', en: 'Master of Mountain River' },
      description: {
        uk: 'Виловити по 1 екземпляру кожного виду риб, що живуть у швидких водах Гірської річки',
        en: 'Catch at least one specimen of every fish species in the swift waters of the Mountain River',
      },
      conditions: [
        {
          id: 'mountain_asp',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'mountain_river',
          value: 'asp',
          target: 1,
          label: { uk: 'Зловити жереха', en: 'Catch an Asp' },
        },
        {
          id: 'mountain_weatherfish',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'mountain_river',
          value: 'weatherfish',
          target: 1,
        ...
        {
          id: 'mountain_brown_trout',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'mountain_river',
          value: 'brown_trout',
          target: 1,
          label: { uk: 'Зловити форель струмкову', en: 'Catch a Brown Trout' },
        },
        {
          id: 'mountain_grayling',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'mountain_river',
          value: 'grayling',
          target: 1,
          label: {
            uk: 'Зловити харіуса європейського',
            en: 'Catch a Grayling',
          },
        },
        {
          ...
          value: 'barbel',
          target: 1,
          label: { uk: 'Зловити марену', en: 'Catch a Barbel' },
        },
        {
          id: 'mountain_danube_salmon',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'mountain_river',
          value: 'danube_salmon',
          target: 1,
          label: {
            uk: 'Зловити дунайського лосося',
            en: 'Catch a Danube Salmon',
          },
        },
        {
          id: 'mountain_pike',
      ...
      order: 9,
      imageUrl:
        'https://ysmdydtvfgtffymgillf.supabase.co/storage/v1/object/public/Game/quests_icons/quest_8_master_of_mountain_river.webp',
    },
    {
      title: { uk: 'Майстер Чорного моря', en: 'Master of Black Sea' },
      description: {
        uk: 'Виловити по 1 екземпляру кожного виду риб у Чорному морі',
        en: 'Catch at least one specimen of every fish species in the Black Sea',
      },
      conditions: [
        {
          id: 'sea_spiny_dogfish',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'black_sea',
          value: 'spiny_dogfish',
          target: 1,
          label: { uk: 'Зловити катрана', en: 'Catch a Spiny Dogfish' },
        },
        {
          id: 'sea_turbot',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          value: 'turbot',
          target: 1,
          label: { uk: 'Зловити камбалу-калкан', en: 'Catch a Turbot' },
        },
        {
          id: 'sea_red_mullet',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          value: 'red_mullet',
          target: 1,
          label: { uk: 'Зловити барабулю', en: 'Catch a Red Mullet' },
        },
        {
          id: 'sea_garfish',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          value: 'garfish',
          target: 1,
          label: { uk: 'Зловити саргана', en: 'Catch a Garfish' },
        },
        {
          id: 'sea_goby',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          value: 'goby',
          target: 1,
          label: { uk: 'Зловити бичка', en: 'Catch a Goby' },
        },
        {
          id: 'sea_annular_seabream',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'black_sea',
          value: 'annular_seabream',
          target: 1,
          label: {
            uk: 'Зловити морського карася',
            en: 'Catch an Annular Seabream',
          },
        },
        {
          id: 'sea_horse_mackerel',
          type: 'CATCH_SPECIES_ON_LAKE',
          lakeId: 'black_sea',
          value: 'horse_mackerel',
          target: 1,
          label: {
            uk: 'Зловити ставриду чорноморську',
            en: 'Catch a Horse Mackerel',
          },
        },
        {
          id: 'sea_mullet',
          ...
          value: 'mullet',
          target: 1,
          label: { uk: 'Зловити кефаль', en: 'Catch a Mullet' },
        },
        {
          id: 'sea_beluga',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          target: 1,
          label: {
            uk: 'Зловити бєлугу чорноморську',
            en: 'Catch a Black Sea Beluga',
          },
        },
        {
          id: 'sea_bonito',
          ...
          value: 'bonito',
          target: 1,
          label: { uk: 'Зловити пеламіду', en: 'Catch a Bonito' },
        },
        {
          id: 'sea_hake',
          type: 'CATCH_SPECIES_ON_LAKE',
          ...
          value: 'hake',
          target: 1,
          label: { uk: 'Зловити хека', en: 'Catch a Hake' },
        },
      ],
      xpReward: 400,
      moneyReward: 1500,
      order: 10,
      imageUrl:
        'https://ysmdydtvfgtffymgillf.supabase.co/storage/v1/object/public/Game/quests_icons/quest_9_master_of_black_sea.webp',
    },
  ];
