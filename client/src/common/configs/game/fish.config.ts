...
export const FISH_SPECIES: Record<string, IFishSpeciesConfig> = {
  ...
  pike: {
    ...
    activityByWeather: { clear: 0.9, cloudy: 1.0, rain: 1.2 },
  ...
  zander: {
    ...
    activityByTimeOfDay: { morning: 0.5, day: 0.2, evening: 1.1, night: 1.3 },
    activityByWeather: { clear: 0.85, cloudy: 1.0, rain: 1.05 },
    preferredBaits: ['live_bait'],
    preferredGroundbait: 'dried_blood',
  ...
  grass_carp: {
    ...
    activityByWeather: { clear: 1.0, cloudy: 1.0, rain: 1.05 },
